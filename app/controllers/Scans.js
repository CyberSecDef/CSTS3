        ...
        */
        grabFiles: function () {
            ...
            $('#myModal').on('shown.bs.modal', function (e) {
                ...
                var table = $('table#tabScanFiles').DataTable({
                    destroy: true,
                    searching: true,
                    paging: 25
                });
        ...
        */
        parseFiles: function () {
            ...
            $('#myModal').on('shown.bs.modal', function (e) {
                ...
                var table = $('table#tabSelFileInfo').DataTable({
                    destroy: true,
                    searching: false,
                    paging: false
                });
            ...
            switch ($(el).data('action')) {
                case 'left':
                    if (fields.mismatch != 'POAM' && fields.mismatch != 'RAR') {
                        ...
                        //viewmodel
                        sel = ko.utils.arrayFilter(csts.controllers.Scans.viewModels.comparison(), function (i) {
                            return i.guid == guid;
                        })[0]
